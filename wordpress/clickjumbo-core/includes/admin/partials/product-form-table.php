...
function clickjumbo_render_product_form_table($dados, $penitenciarias, $categorias)
{
    ...
    <table class="form-table" style="max-width:700px; background:#fff; padding:20px; border:1px solid #ccd0d4; border-radius:6px;">
        ...
        <tr>
            ...
            <td><input name="nome" id="nome" type="text" class="regular-text" required
        ...
        <tr>
            ...
            <td><input type="text" name="subcategoria" id="subcategoria" class="regular-text"
                       placeholder="Ex: Massas, Refrigerantes, etc."
                       value="<?= esc_attr($dados['subcategoria'] ?? '') ?>"></td>
        </tr>
