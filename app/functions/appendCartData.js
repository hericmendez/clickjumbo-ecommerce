...
export const getTotalOrderAmount = (
  ...
  const freteData = getItem("freteData");
  console.log("Fetched from localstorage ==> ", freteData);
  const shipping = freteData?.valor ? parseFloat(freteData.valor) : 0;
...
export const appendCartTotal = (
  ...
  shippingCharges2.innerText =
    shipping > 0 ? `R$${shipping.toFixed(2)}` : "Não calculado";
